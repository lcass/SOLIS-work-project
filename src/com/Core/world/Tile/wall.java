...
public class wall extends Tile{
	...
	private GB graphics;
	public wall(Gamecore core){//refer to for basic tile infomation
		super(core);//required
		info = new infopack();//required
		info.a = "Metal wall";//name
		info.ai = 1;//id
		info.av = new vertex2d(0,0);//position
		this.core = core;//required
		graphics = new GB(core);//graphics object
		graphics.createobject(core.world.shape.square(32, core.world.tiles.getcoords(16, 0, 31,15)), core.world.tiles.gettexture());//required
	}
	public void init(){
		info = new infopack();//required
		info.a = "Metal wall";//name
